...
```
    ...
    install -s mvn:com.github.lburgazzoli/lb-karaf-examples-jpa-common/3.0.1.SNAPSHOT
    install -s mvn:com.github.lburgazzoli/lb-karaf-examples-jpa-hibernate-noaries/3.0.1.SNAPSHOT
```
