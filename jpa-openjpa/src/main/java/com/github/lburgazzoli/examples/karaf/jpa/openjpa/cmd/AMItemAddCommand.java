 ...
 */
package com.github.lburgazzoli.examples.karaf.jpa.openjpa.cmd;

import com.github.lburgazzoli.examples.karaf.jpa.openjpa.data.Item;
 ...
 *
 */
@Command(scope = "item", name = "openjpa-am-add", description = "Add and item (AM)")
